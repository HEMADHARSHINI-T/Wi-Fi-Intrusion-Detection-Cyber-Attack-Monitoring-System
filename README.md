...
- Rapid request (DoS-like) attack detection
- Reconnaissance scan detection (/admin, /config, etc.)
- Risk score calculation for each device
...
4. Suspicious behavior increases risk score
